...
/**
 * This class handles and updates the componements coordinates for x and y, and
 * the selected color that the user choose
 * 
 * @author elal2203
 * @version 1.0
 */
...
public class StatusBarPanel extends JPanel {
	...
	private OnChangeListener<StatusBarPanel> onChangeListenerInterface;
	...
	public StatusBarPanel() {
		 ...
		 * - Skapa en JLabel där det står "Coordinates: ". Lägg till den till leftPanel
		 * via metoden add(Component comp, Object constraints),
		 * dvs den add-metod som tillåter oss ange ett "constraint", i detta fall
		 ...
		 * - Skapa en JLabel där det står "Selected color: ". Lägg till den till
		 * rightPanel på samma sätt som beskrivs i punkt 5.
		 * - Lägg sedan till instansvariabeln selectedColor via samma add-metod som
		 * ovan.
		 */
		// TODO
